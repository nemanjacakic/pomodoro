...
export default {
  ...
  methods: {
    ...
    subtractTime(timeA, timeB) {
      let [minutesA, secondsA] = timeA.split(':');
      let [minutesB, secondsB] = timeB.split(':');
      ...
      if (numberOfMinutesB > numberOfMinutesA) {
        ...
        return false;
      } else if (numberOfMinutesB === numberOfMinutesA && numberOfSecondsB > numberOfSecondsA) {
        throw new Error('Can\'t subtract more time from less');
        return false;
      }
      ...
      if (numberOfSecondsB > numberOfSecondsA) {
        ...
        return String(numberOfMinutesA - numberOfMinutesB).padStart(2, '0') + ":" + String(numberOfSecondsA - numberOfSecondsB).padStart(2, '0');
      } else {
        return String(numberOfMinutesA - numberOfMinutesB).padStart(2, '0') + ":" + String(numberOfSecondsA - numberOfSecondsB).padStart(2, '0');
      }
    },
    ...
    countDown() {
      this.activeTimer.timeLeft = this.subtractTime(this.activeTimer.timeLeft, "00:01");
    },
    countdownFinished() {
      return this.activeTimer.timeLeft === "00:00";
    },
